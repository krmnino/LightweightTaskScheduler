...
int test16(){
    // TEST 16: testing today_add_hms() function -> FAIL
...
int test99(){
    // TEST 99: testing Task::update_execution_datetime() 
    // Frequency: Weekly
    // Datetime format: MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 99 done" << std::endl;
    return 0;
}
...
int test100(){
    ...
    std::cout << ">> Test 100 done" << std::endl;
    return 0;
}
...
int test101(){
    ...
    std::cout << ">> Test 101 done" << std::endl;
    return 0;
}
...
int test102(){
    ...
    std::cout << ">> Test 102 done" << std::endl;
    return 0;
}
...
int test105(){
    ...
    std::cout << ">> Test 105 done" << std::endl;
    return 0;
}


int test106(){
    // TEST 106: testing Task::update_execution_datetime() 
    // Frequency: Monthly
    // Datetime format: YYYY-MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 106 done" << std::endl;
    return 0;
}


int test107(){
    // TEST 107: testing Task::update_execution_datetime() 
    // Frequency: Monthly
    // Datetime format: MM-DD
    ...
    std::cout << ">> Test 107 done" << std::endl;
    return 0;
}


int test108(){
    // TEST 108: testing Task::update_execution_datetime() 
    // Frequency: Monthly
    // Datetime format: YYYY-MM-DD
    ...
    std::cout << ">> Test 108 done" << std::endl;
    return 0;
}
...
int test110(){
    // TEST 110: testing Task::update_execution_datetime() 
    // Frequency: Yearly
    // Datetime format: MM-DD
    ...
    // Add 2 days in seconds and timezone offset
    time_now_add = time_now_add + (2 * 24 * 60 * 60) + (TIMEZONE * 60 * 60);
    to_struct = std::gmtime(&time_now_add);
    struct_time_now_add = *to_struct;
    ...
    std::cout << ">> Test 110 done" << std::endl;
    return 0;
}


int test111(){
    // TEST 111: testing Task::update_execution_datetime() 
    // Frequency: Yearly
    // Datetime format: YYYY-MM-DD
    ...
    std::cout << ">> Test 111 done" << std::endl;
    return 0;
}


int test112(){
    // TEST 112: testing Task::update_execution_datetime() 
    // Frequency: Yearly
    // Datetime format: YYYY-MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 112 done" << std::endl;
    return 0;
}


int test113(){
    // TEST 113: testing Task::update_execution_datetime() 
    // Frequency: Once
    // Datetime format: HH:MM:SS
    ...
    std::cout << ">> Test 113 done" << std::endl;
    return 0;
}


int test114(){
    // TEST 114: testing Task::update_execution_datetime() 
    // Frequency: Once
    // Datetime format: MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 114 done" << std::endl;
    return 0;
}


int test115(){
    // TEST 115: testing Task::update_execution_datetime() 
    // Frequency: Once
    // Datetime format: YYYY-MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 115 done" << std::endl;
    return 0;
}


int test116(){
    // TEST 116: testing Task::update_execution_datetime() 
    // Frequency: Once
    // Datetime format: WDAY HH:MM:SS
    ...
    std::cout << ">> Test 116 done" << std::endl;
    return 0;
}


int test117(){
    // TEST 117: testing Task::update_execution_datetime() 
    // Frequency: Once
    // Datetime format: MM-DD
    ...
    // Add 2 days in seconds and timezone offset to current day
    time_now_add = ts::init_today() + (2 * 24 * 60 * 60) + (TIMEZONE * 60 * 60);
    to_struct = std::gmtime(&time_now_add);
    struct_time_now_add = *to_struct;
    ...
    std::cout << ">> Test 117 done" << std::endl;
    return 0;
}


int test118(){
    // TEST 118: testing Task::update_execution_datetime() 
    // Frequency: Once
    // Datetime format: YYYY-MM-DD
    ...
    std::cout << ">> Test 118 done" << std::endl;
    return 0;
}


int test119(){
    // TEST 119: testing Task::Task() setting execution datetime 
    // Frequency: Once
    // Datetime format: HH:MM:SS
    ...
    std::cout << ">> Test 119 done" << std::endl;
    return 0;
}


int test120(){
    // TEST 120: testing Task::Task() setting execution datetime 
    // Frequency: Once
    // Datetime format: MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 120 done" << std::endl;
    return 0;
}


int test121(){
    // TEST 121: testing Task::Task() setting execution datetime 
    // Frequency: Once
    // Datetime format: YYYY-MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 121 done" << std::endl;
    return 0;
}


int test122(){
    // TEST 122: testing Task::Task() setting execution datetime 
    // Frequency: Once
    // Datetime format: WDAY HH:MM:SS
    ...
    std::cout << ">> Test 122 done" << std::endl;
    return 0;
}


int test123(){
    // TEST 123: testing Task::Task() setting execution datetime 
    // Frequency: Once
    // Datetime format: MM-DD
    ...
    std::cout << ">> Test 123 done" << std::endl;
    return 0;
}


int test124(){
    // TEST 124: testing Task::Task() setting execution datetime 
    // Frequency: Once
    // Datetime format: YYYY-MM-DD
    ...
    std::cout << ">> Test 124 done" << std::endl;
    return 0;
}


int test125(){
    // TEST 125: testing Task::Task() setting execution datetime 
    // Frequency: Hourly
    // Datetime format: n/a
    ...
    // Add 1 hour in seconds and timezone offset
    ...
    std::cout << ">> Test 125 done" << std::endl;
    return 0;
}


int test126(){
    // TEST 126: testing Task::Task() setting execution datetime 
    // Frequency: Daily
    // Datetime format: HH:MM:SS
    ...
    std::cout << ">> Test 126 done" << std::endl;
    return 0;
}


int test127(){
    // TEST 127: testing Task::Task() setting execution datetime 
    // Frequency: Weekly
    // Datetime format: HH:MM:SS
    ...
    std::cout << ">> Test 127 done" << std::endl;
    return 0;
}


int test128(){
    // TEST 128: testing Task::Task() setting execution datetime 
    // Frequency: Weekly
    // Datetime format: MM-DD HH:MM:SS
    ...
    // Add two days and one hour in seconds to current time
    // Add timezone offset    
    time_now_add = time_now + (2 * 24 * 60 * 60) + (1 * 60 * 60) + (TIMEZONE * 60 * 60);
    to_struct = std::gmtime(&time_now_add);
    struct_time_now_add = *to_struct;
    ...
    std::cout << ">> Test 128 done" << std::endl;
    return 0;
}


int test129(){
    // TEST 129: testing Task::Task() setting execution datetime 
    // Frequency: Weekly
    // Datetime format: YYYY-MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 129 done" << std::endl;
    return 0;
}


int test130(){
    // TEST 130: testing Task::Task() setting execution datetime 
    // Frequency: Weekly
    // Datetime format: WDAY HH:MM:SS
    ...
    std::cout << ">> Test 130 done" << std::endl;
    return 0;
}


int test131(){
    // TEST 131: testing Task::Task() setting execution datetime 
    // Frequency: Weekly
    // Datetime format: YYYY-MM-DD
    ...
    std::cout << ">> Test 131 done" << std::endl;
    return 0;
}


int test132(){
    // TEST 132: testing Task::Task() setting execution datetime 
    // Frequency: Weekly
    // Datetime format: MM-DD
    ...
    std::cout << ">> Test 132 done" << std::endl;
    return 0;
}


int test133(){
    // TEST 133: testing Task::Task() setting execution datetime 
    // Frequency: Monthly
    // Datetime format: HH:MM:SS
    ...
    std::cout << ">> Test 133 done" << std::endl;
    return 0;
}


int test134(){
    // TEST 134: testing Task::Task() setting execution datetime 
    // Frequency: Monthly
    // Datetime format: MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 134 done" << std::endl;
    return 0;
}


int test135(){
    // TEST 135: testing Task::Task() setting execution datetime 
    // Frequency: Monthly
    // Datetime format: YYYY-MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 135 done" << std::endl;
    assert(time_now_add == t->get_execution_datetime(true));
    return 0;
}
...
int test136(){
    // TEST 136: testing Task::Task() setting execution datetime 
    // Frequency: Monthly
    // Datetime format: MM-DD
    ...
    // Add timezone offset plus 2 days in seconds
    time_now_add = ts::init_today() + (TIMEZONE * 60 * 60) + (2 * 24 * 60 * 60);
    to_struct = std::gmtime(&time_now_add);
    struct_time_now_add = *to_struct;
    ...
    std::cout << ">> Test 136 done" << std::endl;
    return 0;
}


int test137(){
    // TEST 137: testing Task::Task() setting execution datetime 
    // Frequency: Monthly
    // Datetime format: YYYY-MM-DD
    ...
    std::cout << ">> Test 137 done" << std::endl;
    return 0;
}


int test138(){
    // TEST 138: testing Task::Task() setting execution datetime 
    // Frequency: Yearly
    // Datetime format: MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 138 done" << std::endl;
    return 0;
}


int test139(){
    // TEST 139: testing Task::Task() setting execution datetime 
    // Frequency: Yearly
    // Datetime format: MM-DD
    ...
    std::cout << ">> Test 139 done" << std::endl;
    return 0;
}


int test140(){
    // TEST 140: testing Task::Task() setting execution datetime 
    // Frequency: Yearly
    // Datetime format: YYYY-MM-DD
    ...
    std::cout << ">> Test 140 done" << std::endl;
    return 0;
}


int test141(){
    // TEST 141: testing Task::Task() setting execution datetime 
    // Frequency: Yearly
    // Datetime format: YYYY-MM-DD HH:MM:SS
    ...
    std::cout << ">> Test 141 done" << std::endl;
    return 0;
}
