...
int test1(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Weekly: 1 done" << std::endl;
    return 0;
}
...
int test2(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Weekly: 2 done" << std::endl;
    return 0;
}
...
int test3(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Weekly: 3 done" << std::endl;
    return 0;
}
...
int test4(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Weekly: 4 done" << std::endl;
    return 0;
}
...
int test5(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Weekly: 5 done" << std::endl;
    return 0;
}
...
int test6(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Weekly: 6 done" << std::endl;
    return 0;
}
