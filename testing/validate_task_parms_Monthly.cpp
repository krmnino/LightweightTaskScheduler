...
int test1(){
    ...
    std::cout << ">> validate_task_parms_Monthly: 1 done" << std::endl;
    return 0;
}
...
int test2(){
    ...
    std::cout << ">> validate_task_parms_Monthly: 2 done" << std::endl;
    return 0;
}
...
int test3(){
    ...
    // Current time plus one minute in seconds 
    // Pass incompatible datetime WDAY_HHMMSS formats. 
    // Frequency = Monthly
    ...
    for(size_t i = 0; i < datetimes.size(); i++){
        ...
        assert(ret == lts::ValidationCode::INCOMPATIBLE_MONTHLY_FREQ_DATETIME_FORMAT);

        delete c;
    }

    std::cout << ">> validate_task_parms_Monthly: 3 done" << std::endl;
    return 0;
}
...
int test4(){
    ...
    std::cout << ">> validate_task_parms_Monthly: 4 done" << std::endl;
    return 0;
}
...
int test5(){
    ...
    std::cout << ">> validate_task_parms_Monthly: 5 done" << std::endl;
    return 0;
}
...
int test6(){
    ...
    std::cout << ">> validate_task_parms_Monthly: 6 done" << std::endl;
    return 0;
}
...
int test8(){
    ...
    std::cout << ">> validate_task_parms_Monthly: 8 done" << std::endl;
    return 0;
}
