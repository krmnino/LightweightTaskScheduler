...
int test4(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Hourly: 4 done" << std::endl;
    return 0;
}
...
int test5(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Hourly: 5 done" << std::endl;
    return 0;
}


int test6(){
    // TEST 6: attempt to initialize Task with invalid datetime values
    // Frequency: Hourly
    // Datetime format: HH:MM:SS, YYYY-MM-DD HH:MM:SS
    ...
    std::cout << ">> Task_setting_exec_datetime_Hourly: 7 done" << std::endl;
    return 0;
}
