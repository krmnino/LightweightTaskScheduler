...
int test1(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Monthly: 1 done" << std::endl;
    return 0;
}
...
int test2(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Monthly: 2 done" << std::endl;
    return 0;
}
...
int test3(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Monthly: 3 done" << std::endl;
    return 0;
}
...
int test4(){
    ...
    std::cout << ">> Task_setting_exec_datetime_Monthly: 4 done" << std::endl;
    return 0;
}
