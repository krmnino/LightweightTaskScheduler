...
int test1(){
    ...
    // Add one hour in seconds to initial execution time
    // Add timezone offset
    time_now_add = time_now_add + (60 * 60) + (TIMEZONE * 60 * 60);
...
int test2(){
    ...
    std::cout << ">> Task_update_execution_datetime_Hourly: 2 done" << std::endl;
    return 0;
}
