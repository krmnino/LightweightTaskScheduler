...
int test5(ts::Scheduler* s, ts::EventReporter* e){
    ...
    std::string original_task_filename;
    std::string rename_task_filename;
    std::string task_filename;
    std::string task_name;
    ts::Event ret_event;
    std::string verify_event_message;
    ...
    original_task_filename = "tasks/cat_test.cl";
    rename_task_filename = "tasks/original_cat_test.cl";
    task_filename = "cat_test.cl";
    task_name = "cat";
    ...
    // Temporarily task configuration filename so the Scheduler can't find it
    rename(original_task_filename.c_str(), rename_task_filename.c_str());
